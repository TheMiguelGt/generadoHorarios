# Generated by Django 4.0.8 on 2022-10-20 16:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_profile_pic', models.ImageField(blank=True, upload_to='usuario/admin_profile_pic')),
            ],
        ),
        migrations.CreateModel(
            name='Alumno',
            fields=[
                ...
                ('apemat', models.CharField(max_length=50)),
                ('email', models.EmailField(max_length=254)),
                ('alumno_profile_pic', models.ImageField(blank=True, upload_to='usuario/alumno_profile_pic')),
            ],
        ),
        migrations.CreateModel(
            name='Coordina',
            fields=[
                ...
                ('apemat', models.CharField(max_length=50)),
                ('email', models.EmailField(max_length=254)),
                ('coordina_profile_pic', models.ImageField(blank=True, upload_to='usuario/cordina_profile_pic')),
            ],
        ),
        migrations.CreateModel(
            name='Docente',
            fields=[
                ...
                ('apemat', models.CharField(max_length=50)),
                ('email', models.EmailField(max_length=254)),
                ('docente_profile_pic', models.ImageField(blank=True, upload_to='usuario/docente_profile_pic')),
            ],
        ),
    ]
