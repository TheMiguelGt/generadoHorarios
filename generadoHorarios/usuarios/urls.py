...
from .views import CoordinaListView,ProfileView,CoordinaUpView,CoordinaDelete,AdminListView,AdminSignUp,AdminDetailView,AdminUpView,DocenteListView,AlumnoListView
